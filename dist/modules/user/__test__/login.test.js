...
// src/modules/user/__test__/login.test.ts
...
// src/modules/user/__test__/login.test.ts
(0, import_tap.test)("POST `/api/users/login`", () => __async(exports, null, function* () {
  (0, import_tap.test)("given the email and password are correct", (t) => __async(exports, null, function* () {
    ...
    const verified = fastify.jwt.verify(
  ...
  (0, import_tap.test)("given the email and password are not correct", (t) => __async(exports, null, function* () {
    const name = import_faker.default.name.findName();
    const email = import_faker.default.internet.email();
    const password = import_faker.default.internet.password();
    const fastify = server_default();
